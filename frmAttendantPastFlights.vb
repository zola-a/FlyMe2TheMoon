...
Public Class frmAttendantPastFlights
    ...
    Private Sub LoadPastFlights()
        ...
        lblTotalMiles.Text = "Total Miles (past): 0"
        ...
        Try
            ...
            dr.Close()
            lblTotalMiles.Text = "Total Miles (past): " & totalMiles
            CloseDatabaseConnection()

        Catch ex As Exception
            MessageBox.Show("Error loading past flights: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            CloseDatabaseConnection()
        End Try
    End Sub
